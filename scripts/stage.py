...
DEST.mkdir()
for name in ['index.html','review.html','guide.html','.nojekyll','README.md','AI_CHALLENGE.md','CONTRIBUTING.md','METHODOLOGY.md','SAFETY.md','LICENSE','challenge.json','assets','research','schemas','docs']:
